# Agent Instructions Contract: Teamind MVP

**Source**: design-spec-v5.md § 4 "What the injected instructions tell agents"
**Injected by**: `teamind init` → T020 (CLAUDE.md/AGENTS.md marker injection)

## Exact Injection Content

This text is placed between `<!-- teamind:start -->` and `<!-- teamind:end -->`
