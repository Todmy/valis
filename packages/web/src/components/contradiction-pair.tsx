    ...
    <div className="border border-red-200 rounded-lg p-4 bg-red-50">
      ...
      <div className="flex items-center justify-between mb-3">
        <div className="flex items-center gap-2">
          <span className="text-sm font-medium text-red-700">Contradiction</span>
      ...
      {contradiction.overlap_areas.length > 0 && (
        <div className="flex flex-wrap gap-1 mb-3">
          <span className="text-xs text-gray-500 mr-1">Overlap:</span>
...
function DecisionSide({
  ...
  return (
    <div className="bg-white rounded-md p-3 border border-gray-200">
      ...
      {decision.summary && (
        <div className="text-sm font-medium text-gray-900 mb-1">{decision.summary}</div>
      )}
      <div className="text-xs text-gray-600 line-clamp-3">{decision.detail}</div>
